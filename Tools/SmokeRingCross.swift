// 冒烟测试:「Tab/⇧Tab 换环」(2026-09-22)。
//
// ⚠️ 先看设置:`panel.tabEntersLaunchSection`
//   · **开** ⇒ 期望:两个方向都跨段(日志里出现两条 `[T91] 段切换` ✓)
//   · **关** ⇒ 期望:**都不跨段**,段落内绕回(日志里**没有** `[T91] 段切换`,只有 `[T6] 选中` ✓)
//   这个脚本本身**不改**设置(改用户的开关是越界 ✗),跑完请自己对一眼上面的期望 ✓
//
