...
enum PanelElevation {
    ...
    var shadow: Layer {
        ...
        case .strip: Layer(y: 30, radius: 30, light: 0.06, dark: 0.62) // 0 30px 60px
        ...
        // 同一物理:托盘是同一块玻璃,浅色一并对齐(深色不动 —— 深色底上那圈不是"糊",是"浮起")
        case .tray: Layer(y: 14, radius: 13, light: 0.05, dark: 0.55)
