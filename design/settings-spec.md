...
**改法**(token 都在 `SettingsTheme`):

| 元素 | 改前 | 改后 |
|---|---|---|
| 组标题字号/字重 | 11pt regular | **13pt semibold** |
| 组标题颜色 | `ink2`(墨 56%) | **`ink`** |
| 组标题容器 | 4pt 圆点 + 文字 | **发丝边框胶囊**(`labelBorder` 墨 15% / 白 17%,圆角 8,内边距 9×4) |
| 行说明 | 11.5pt | 12pt |
...
组与组之间靠**间距 + 边框**分区,不靠"每行均匀地松"。对照图:`design/设置排版实验台.html`
(`python3 design/settings-typography-lab.py` 重出)。
